        ...
        {dashData?.latestAppointments?.length > 0 ? (
            dashData.latestAppointments.map((item, index) => (
                <div key={index} className='flex items-center px-6 py-3 gap-3 hover:bg-gray-100'>
                    <img className='rounded-full w-10' src={item.userData.image} alt={`Profile of ${item.userData.name}`} />
            ...
            <p className='text-gray-500 text-center'>No latest bookings available.</p>
        )}
    </div>
</div>
